...
//   const {user}=useAuth()
  ...
  const handleSubmit = (e) => {
    ...
    axios.put('http://localhost:3000/jobupdate',jobPostingData).then(res=>{
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <input
                    ...
                    defaultValue={data.salaryRange.min}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="40000"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    defaultValue={data.salaryRange.max}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="60000"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    defaultValue={data.salaryRange.currency}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                    {currencies.map(curr => (
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <input
                ...
                defaultValue={data.responsibilities.join(',')}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
