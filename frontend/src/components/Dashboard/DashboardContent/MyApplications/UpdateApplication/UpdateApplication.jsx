...
export default function UpdateApplication() {
  ...
  useEffect(() => {
    fetch(`http://localhost:3000/job/${application.jobId}`).then(res => res.json()).then(data => {
      setJob(data)
    })
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm(data)) {
      ...
      axios.put('http://localhost:3000/updateapp', data).then(res => {
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.fullName ? 'border-red-500' : 'border-gray-300'
                    }`}
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                // onChange={handleInputChange}
                rows="2"
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.address ? 'border-red-500' : 'border-gray-300'
                  }`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  //   onChange={handleInputChange}
                  className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.experience ? 'border-red-500' : 'border-gray-300'
                    }`}
                >
              ...
              <div>
                ...
                <input
                  ...
                  defaultValue={application.availableStartDate}
                  //   value={formData.availableStartDate}
                  //   onChange={handleInputChange}
                  className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.availableStartDate ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  name="education"
                  defaultValue={application.education}
          ...
          <div className="mb-8">
            ...
            <div>
              ...
              <textarea
                ...
                // onChange={handleInputChange}
                defaultValue={application.additionalSkills.join(',')}
                rows="3"
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="mb-8">
            ...
            <textarea
              ...
              //   onChange={handleInputChange}
              rows="6"
              className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.coverLetter ? 'border-red-500' : 'border-gray-300'
                }`}
          ...
          <div className="mb-8">
            ...
            <textarea
              ...
              defaultValue={application.previousExperience}
